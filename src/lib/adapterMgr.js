...
class AdapterMgr {
  ...
  constructor ( plug ) {
    ...
    /** @type {Record<string, import('./adapterBase')>} */
    this._adapters = {};
    ...
    /**
     * @type {Record< string, import('@sequelize/core').Options>}
     *  - key string format: <host:port@database>, example: 127.0.0.1:111@radar
     *
     */
    this.dbMap = {};

    /** @type { Record<string, {dbKey: string, adaIns: import('./adapterBase')}>} db 和db 实例名映射*/
    this.dbNameMap = {};

    /** @type { Record<string, { mo: import('@sequelize/core').Model, adaIns: import('./adapterBase')}>} 表和模型的映射关系*/
    this.tableModelMap = {};
   ...
   * @returns { import('@sequelize/core').Model | null }
